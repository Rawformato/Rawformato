...
export default function Restaurants() {
  ...
  const showcaseVideos = [
    ...
    { src: `${VIDEO_BASE}/delucas.mp4`, title: 'Fine Dining Experience', category: 'Fine Dining' },
    { src: `${VIDEO_BASE}/copa.mp4`, title: 'Cocktail Bar Vibes', category: 'Bar & Lounge' },
    { src: `${VIDEO_BASE}/asmr_a_la_cruz.mp4`, title: 'Gastronomy ASMR', category: 'Gastronomy' },
    { src: `${VIDEO_BASE}/el_atico_trendy.mp4`, title: 'Rooftop Vibes', category: 'Rooftop Bar' },
    { src: `${VIDEO_BASE}/pisco_lounge.mp4`, title: 'Cocktail Lounge', category: 'Cocktails' },
  ];

  const reelVideos = [
    `${VIDEO_BASE}/hausmash.mp4`,
    `${VIDEO_BASE}/delucas.mp4`,
    `${VIDEO_BASE}/pov_a_la_cruz.mp4`,
    `${VIDEO_BASE}/copa.mp4`,
    `${VIDEO_BASE}/wine_cellar.mp4`,
    `${VIDEO_BASE}/asmr_a_la_cruz.mp4`,
    `${VIDEO_BASE}/el_atico_trendy.mp4`,
    `${VIDEO_BASE}/pisco_lounge.mp4`,
  ];
    ...
    <div className="relative">
      ...
      <PhotoGallery
        ...
        photos={[
          ...
          { src: '/photos/restaurants/sushi-roll.webp', alt: 'Sushi roll with flower garnish' },
          { src: '/photos/restaurants/burrata-prosciutto.webp', alt: 'Burrata with prosciutto' },
          { src: '/photos/restaurants/latte-art.webp', alt: 'Latte art pour' },
          { src: '/photos/restaurants/causa-peruvian.webp', alt: 'Peruvian causa dish' },
          { src: '/photos/restaurants/smash-burger.webp', alt: 'Flaming smash burger' },
          { src: '/photos/restaurants/pisco-sour.webp', alt: 'Pisco sour cocktail' },
          { src: '/photos/restaurants/seafood-platter.webp', alt: 'Grilled seafood platter' },
          { src: '/photos/restaurants/espresso-martini.webp', alt: 'Espresso martini' },
          { src: '/photos/restaurants/pasta-tomato.webp', alt: 'Spaghetti with tomato sauce' },
          { src: '/photos/restaurants/affogato-dessert.webp', alt: 'Affogato dessert' },
          { src: '/photos/restaurants/spicy-cocktail.webp', alt: 'Spicy cocktail with garnish' },
          { src: '/photos/restaurants/shrimp-rice.webp', alt: 'Shrimp with rice and plantains' },
          { src: '/photos/restaurants/gelato-scoop.webp', alt: 'Artisan gelato' },
          { src: '/photos/restaurants/burrata-landscape.webp', alt: 'Burrata plating' },
          { src: '/photos/restaurants/sangria-cocktails.webp', alt: 'Sangria cocktails' },
          { src: '/photos/restaurants/gnocchi.webp', alt: 'Gnocchi in butter sauce' },
          { src: '/photos/restaurants/hot-chocolate.webp', alt: 'Artisan hot chocolate' },
          { src: '/photos/restaurants/calamari-rings.webp', alt: 'Crispy calamari rings' },
          { src: '/photos/restaurants/samosas.webp', alt: 'Samosas with chili sauce' },
          { src: '/photos/restaurants/milanesa-sandwich.webp', alt: 'Milanesa with mashed potatoes' },
          { src: '/photos/restaurants/shrimp-patacones.webp', alt: 'Shrimp with patacones' },
          { src: '/photos/restaurants/burrata-closeup.webp', alt: 'Burrata closeup' },
        ]}
      />
      ...
      <section className="relative py-24 lg:py-32 overflow-hidden">
        <div className="absolute inset-0">
          <LazyVideo src={`${VIDEO_BASE}/wine_cellar.mp4`} className="w-full h-full object-cover" />
