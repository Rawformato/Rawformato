...
export function ServiceCard({ icon, title, description }: ServiceCardProps) {
  return (
    <div
      className="group relative p-6 rounded-xl border border-white/10 bg-[#F2F2F2]/[0.02] transition-all hover:border-[#E5E5E5]/50 hover:scale-[1.02] transition-transform duration-200"
    >
      {/* Glow effect */}
